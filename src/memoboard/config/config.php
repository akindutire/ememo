<?php
namespace src\memoboard\config;

use \zil\core\interfaces\Config as ConfigInf;

use src\memoboard\route\Web;
use src\memoboard\route\Api;
...
class Config implements ConfigInf{
	...
	public function getRoutes(): array{
		...
		#Converge Route to convey to system
	...
	public function options(): array{
		...
		return [
            ...
            'projectBasePath' => '/ememo/',
            'appGuardClass' => '\src\memoboard\service\GuardL'
		];
