...
models.memoSubject = '{! $Template->name !}';
...
<section class="" style="padding: 70px 0px 10px 0px;">
    <div class="container">
        ...
        <h3 class="w-25">Use/Send your memo</h3> <input type="button" ng-click="states.previewMode = !states.previewMode; updateBodyForState();" class="btn btn-info" value="Toggle Preview" />
    </div>
</section>
...
<script type="text/javascript">
    ...
    window.addEventListener("load", function() {
        tinymce.get('MemoMessage').setContent('{! $template !}');
