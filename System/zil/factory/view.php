    ...
    public static function viewProcessor(string $view) : string{
        ...
        try{
            ...
            if (file_exists("{$parent->curAppPath}{$parent->viewPath}{$view}") === true) {
                ...
                /**
                 * Extract views to sections from expansion panel
                 * Replace sections placeholder with corresponding expansion panel
                 */
                ...
                foreach($sections as $section){
                    ...
                    foreach($lookupcontent as $index => $line){
                ...
                if(sizeof($sections) > 0)
                    unset($lookupcontent, $expansions, $write, $expand_found, $sections);
